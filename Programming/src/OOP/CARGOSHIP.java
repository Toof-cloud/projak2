...
public class CARGOSHIP {
	public static void main(String[] args) {
		...
		System.out.println("Origin of Shipment: ");
		String origin40 = sc.nextLine();
		System.out.println("Port of destination and disembarkation: ");
		String destination40 = sc.nextLine();
		System.out.println("Number of 40-Foot Containers: ");
		int number40 = Integer.parseInt(sc.nextLine());
		System.out.println("Weight per Container (kg): ");
		double weight40 = Double.parseDouble(sc.nextLine());
		System.out.println("Price per Container (Php): ");
		double price40 = Double.parseDouble(sc.nextLine());
		System.out.println("Tax per Container (Php): ");
